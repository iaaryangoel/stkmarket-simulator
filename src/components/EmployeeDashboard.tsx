...
const EmployeeDashboard = () => {
  ...
  return (
    <div className="space-y-6">
            ...
            <table className="w-full">
              ...
              {shares.map(s => (
                <tr key={s._id} className="border-b">
                  ...
                  <td className={`p-2 text-right ${s.change >= 0 ? 'text-green-600' : 'text-red-600'}`}>
      ...
      {/* Trading Interface */}
      <Card>
        <CardHeader><CardTitle>Trading Interface</CardTitle></CardHeader>
        <CardContent>
              ...
              <form onSubmit={handleDirectTrade} className="space-y-4">
                <div className="grid md:grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <select name="participantId" className="w-full border p-2 rounded" required>
                  ...
                  <div>
                    <Label>Share</Label>
                    <select name="shareSymbol" className="w-full border p-2 rounded" required>
                      <option value="">Select</option>
                      {shares.map(s => (
                  ...
                  <div>
                    <Label>Action</Label>
                    <select name="action" className="w-full border p-2 rounded" required>
            ...
            <TabsContent value="p2p" className="space-y-4">
              <form onSubmit={handleP2PTrade} className="space-y-4">
                <div className="grid md:grid-cols-2 gap-4">
                  ...
                  <div>
                    <Label>Buyer</Label>
                    <select name="buyerParticipantId" className="w-full border p-2 rounded" required>
                  ...
                  <div>
                    <Label>Seller</Label>
                    <select name="sellerParticipantId" className="w-full border p-2 rounded" required>
                  ...
                  <div>
                    <Label>Share</Label>
                    <select name="p2pShareSymbol" className="w-full border p-2 rounded" required>
                      <option value="">Select</option>
                      {shares.map(s => (
                  ...
                  <div>
                    ...
                    <Input name="p2pPrice" type="number" step="0.01" min="0" required />
                  </div>
                </div>
      ...
      {/* Active Participants */}
      <Card>
        <CardHeader><CardTitle>Active Participants</CardTitle></CardHeader>
        <CardContent>
          <div className="overflow-x-auto">
            <table className="w-full">
              <thead>
              ...
              {participants.map(p => (
                <tr key={p._id} className="border-b">
                  ...
                  <td className="p-2 text-right">₹{p.balance.toLocaleString()}</td>
                  <td className="p-2 text-right">{p.holdings?.length || 0}</td>
                </tr>
              ))}
              </tbody>
            </table>
